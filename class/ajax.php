...
class CPM_Ajax {
    ...
    public function __construct() {
        ...
        add_action( 'wp_ajax_cpm_tasks_update_priority', array($this, 'update_tasks_priority') );
        ...
        add_action( 'wp_ajax_cpm_tasks_by_priority', array($this, 'get_tasks_by_priority') );
    ...
    function update_tasks_priority() {
        check_ajax_referer( 'cpm_nonce' );

        $task_obj = CPM_Task::getInstance();
        $res = $task_obj->update_tasks_priority( $_POST['tasks'], $_POST['user_id'], $_POST['direction'] );
